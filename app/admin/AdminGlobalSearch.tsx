...
export function AdminGlobalSearch() {
  ...
  return (
    <div className="relative w-full max-w-2xl">
      ...
      {query.trim().length >= 2 ? (
        <div className="absolute left-0 right-0 top-full z-30 mt-2 overflow-hidden rounded-[1.45rem] border border-white/10 bg-black/95 p-3 shadow-2xl shadow-black/40 backdrop-blur-2xl">
          {status === "loading" ? (
