...
export const industryBenchmarks: Record<IndustryKey, IndustryBenchmark> = {
  ...
  luxuryCoffee: {
    key: "luxuryCoffee",
    label: "Food & Beverage / Specialty Coffee",
    benchmarkBasis:
      "Specialty coffee and premium food & beverage benchmarks adjusted for D2C unit sales, subscription repeat purchase, B2B wholesale, retail footprint, and brand-led acquisition.",
    confidence: "Medium",
    ranges: {
    ...
    modeling: {
      ...
      somRate: 0.006,
      arpaMonthly: 22,
      month12Customers: 4_200,
      customerGrowthRate: 0.34,
      cacUsd: 34,
      grossMarginRate: 0.54,
      lifetimeMonths: 11,
      monthlyBurnUsd: 120_000,
